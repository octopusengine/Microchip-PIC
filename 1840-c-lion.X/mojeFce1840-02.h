...
//    output: none
/////////////////////////////////////////////////////////////////////////////////////////
void delay_ms4(unsigned int duration) // delay in miliseconds for 4.0MHZ crystal
{
    unsigned int i;
...
void beepBlik3(int co1, int co2, int co3, int co5, int set5)
{
  int sGPIO = 0;
  if (set5) setbit(sGPIO,co5);
  else clrbit(sGPIO,co5);
...
void uart_init()
{
    APFCONbits.TXCKSEL  = 0; //1 = TX/CK function is on RA4 / 0 na RA0
